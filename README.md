...
<h2>Description</h2>
Confgiure HSRP on DSW1/DSW2 and synchronize with STP within separate VLANs. Purpose is to create priority traffic path from PC1 > DSW1 and PC2 > DSW2 with HSRP. Verify results with commands 'show standby' and 'show spanning-tree'.
